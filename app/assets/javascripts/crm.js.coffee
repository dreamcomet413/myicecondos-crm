...
(($) ->
  ...
  $(document).on 'click', '#lead_details .tabs a', ->
  ...
  $(document).on 'click', "#cancel_new_call", (e) ->
    e.preventDefault()
    $("#new_call_container").hide()

  $(document).on 'click', "#add_user_lead_rule", (e) ->
    e.preventDefault()
    $(".rules").append("<div>" + $(".lead_rotation_row").first().html() + "</div>")

  $(document).on 'click', "#add_campaign_email", (e) ->
    e.preventDefault()
    $("#campaign_email_form").show()

  $(document).on 'click', "#cancel_add_campaign_email", (e) ->
    e.preventDefault()
    $("#campaign_email_form").hide()

  $(document).on 'click', "#send_lead_email", (e) ->
    e.preventDefault()
    $("#send_lead_email").hide()
    $("#new_lead_email").show()
