...
ActiveRecord::Schema.define(:version => 20151009232654) do
  ...
  create_table "lead_assignment_rules", :force => true do |t|
    t.string   "title"
    t.string   "source"
    t.text     "information"
    t.datetime "created_at",  :null => false
  ...
  create_table "leads", :force => true do |t|
    ...
    t.string   "skype",                           :limit => 128
    t.text     "subscribed_users"
    t.string   "buying_info_owns"
    t.string   "buying_info_planning"
    t.float    "buying_info_price_from"
    t.float    "buying_info_price_to"
    t.string   "buying_info_property_type"
    t.string   "buying_info_construction_type"
    t.string   "buying_info_bedrooms"
    t.string   "buying_info_bathrooms"
    t.string   "buying_info_interest"
    t.string   "buying_info_city"
    t.string   "buying_info_mortgage"
    t.string   "buying_info_garage"
    t.string   "listing_info_property_type"
    t.string   "listing_info_address"
    t.string   "listing_info_property_condition"
    t.string   "listing_info_city"
    t.string   "listing_info_parking_type"
    t.string   "listing_info_postal_code"
    t.string   "listing_info_basement"
    t.string   "listing_info_lead_is"
    t.string   "listing_info_status"
    t.string   "listing_info_bedrooms"
    t.string   "listing_info_bathrooms"
    t.string   "listing_info_sell_in"
    t.integer  "price_search_radius"
